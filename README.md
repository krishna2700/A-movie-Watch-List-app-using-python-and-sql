...
De applicatie maakt gebruik van drie tabellen:
...
| Kolom | Type | Beschrijving |
|---|---|---|
| `username` | TEXT (PK) | Unieke gebruikersnaam |

### `watched`
| Kolom | Type | Beschrijving |
|---|---|---|
| `user_username` | TEXT (FK) | Verwijzing naar `users.username` |
| `movie_id` | INTEGER (FK) | Verwijzing naar `movies.id` |
...
> Keuze: 1
  Filmtitel: Inception
  Releasedatum (dd-mm-JJJJ): 16-07-2010

> Keuze: 3
  -- Alle films --
  1: Inception (op Jul 16 2010)
